...
export declare namespace model {
    function event(event: string, property?: string): <T extends IModelView<M>, M>(target: T, prop: string, desc: TypedPropertyDescriptor<(...args: any[]) => any>) => void;
    function change(property?: string): <T extends IModelView<M>, M>(target: T, prop: string, desc: TypedPropertyDescriptor<(...args: any[]) => any>) => void;
}
