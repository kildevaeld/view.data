(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@viewjs/utils'), require('@viewjs/events'), require('@viewjs/view')) :
	typeof define === 'function' && define.amd ? define(['exports', '@viewjs/utils', '@viewjs/events', '@viewjs/view'], factory) :
	(factory((global.viewjs = global.viewjs || {}, global.viewjs.data = {}),global.viewjs.utils,global.viewjs.events,global.viewjs.view));
}(this, (function (exports,utils,events,view) { 'use strict';
