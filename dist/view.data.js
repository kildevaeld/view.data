(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@viewjs/utils'), require('@viewjs/view'), require('@viewjs/events'), require('@viewjs/html'), require('@viewjs/models')) :
  typeof define === 'function' && define.amd ? define(['exports', '@viewjs/utils', '@viewjs/view', '@viewjs/events', '@viewjs/html', '@viewjs/models'], factory) :
  (factory((global.viewjs = global.viewjs || {}, global.viewjs.data = {}),global.viewjs.utils,global.viewjs.view,global.viewjs.events,global.viewjs.html,global.viewjs.models));
}(this, (function (exports,utils,view,events,html,models) { 'use strict';
    ...
    return (
      ...
      function (_Base) {
        ...
        function _class() {
          ...
          if (MModel && _this.collection && _this.collection instanceof models.ModelCollection) {
        ...
        _createClass(_class, [{
          ...
          value: function _addModelEvents() {
            if (events.isEventEmitter(this.collection)) {
              this.collection.on(models.ModelEvents.Add, this._modelAdded, this);
              this.collection.on(models.ModelEvents.Remove, this._modelRemoved, this);
              this.collection.on(models.ModelEvents.Reset, this.render, this);
              this.collection.on(models.ModelEvents.Sort, this.render, this);
            }
          }
        }, {
